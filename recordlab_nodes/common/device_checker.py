...
#   sensors       List of Xr.SensorType name strings the device physically supports.
#   imu_count     Number of IMU sensors (1 or 2).
...
_USB_PRODUCT_CATALOG: List[Dict[str, Any]] = [
    {"vid": "0x3318", "pid": "0x0420", "names": ["Air", "P55", "Flora"],
     ...
     "sensors": ["Imu", "Display"], "imu_count": 1,
    ...
    {"vid": "0x3318", "pid": "0x0436", "name": "Gina",
     ...
     "sensors": ["Imu", "Display"], "imu_count": 2,
     "remarks": ["0x0001"]},
    ...
    {"vid": "0x3318", "pid": "0x043a", "name": "Hylla",
     ...
     "supports_bsp": True, "supports_nviz": True, "device_color": "blue",
     "device_group": "ssh_nviz",
     "sensors": ["Imu", "Slam", "Display"], "imu_count": 1,
     "remarks": ["0x0001"]},
