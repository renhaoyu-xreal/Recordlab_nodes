...
def build_report(project_root: Path) -> Dict[str, Any]:
    ...
    syntax_paths = [
        project_root / "scripts/runtime/run_recordlab_script.py",
        project_root / "scripts/runtime/run_recording_worker.py",
        project_root / "node_scripts/record_bsp_imu.py",
        project_root / "node_scripts/record_bsp_imu_cam.py",
        project_root / "node_scripts/record_bsp_imu_static.py",
        project_root / "node_scripts/record_bsp_imu_dynamic.py",
    ]
